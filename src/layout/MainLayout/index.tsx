...
const MainLayout: React.FC<MainLayoutProps> = ({
  ...
  const preview =
    currentStep === 3
      ...
      : cardImg
  return (
    <div className="flex flex-col-reverse justify-end w-full min-h-screen md:flex-row md:justify-between md:max-h-screen">
      <div
        className={cs(
      ...
      >
        {hasCard && (
          <>
            <div className="relative z-10 w-8/12 py-2 mt-16 text-center rounded-lg bg-snow 2xl:mt-28 2xl:w-6/12">
